...
def main() -> None:
    ...
    model_cfg = ModelConfig(
        ...
        smolgen_hidden_channels=int(flat.get("smolgen_hidden_channels", 32)),
        smolgen_hidden_sz=int(flat.get("smolgen_hidden_sz", 256)),
        smolgen_gen_sz=int(flat.get("smolgen_gen_sz", 256)),
