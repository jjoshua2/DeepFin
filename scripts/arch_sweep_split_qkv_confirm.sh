...
watch_log="/tmp/offline_replay_epoch_arch_split_qkv_confirm.log"
...
experiments=(
  "arch_11l_splitqkv_mlp_out_seed1|runs/offline_replay_epoch_arch_11l_splitqkv_mlp_out_seed1_${stamp}|--seed 1 --candidates aurora_mlp_out"
  "arch_11l_splitqkv_mlp_out_seed2|runs/offline_replay_epoch_arch_11l_splitqkv_mlp_out_seed2_${stamp}|--seed 2 --candidates aurora_mlp_out"
  "arch_11l_splitqkv_mlp_out_seed3|runs/offline_replay_epoch_arch_11l_splitqkv_mlp_out_seed3_${stamp}|--seed 3 --candidates aurora_mlp_out"
)
...
log "starting split-QKV confirmation queue: duration=${duration_s}s max_jobs=${max_jobs}"
start_s="$(date +%s)"
last_summary_s=0
