...
def bench(label: str, model, evaluator, boards, cboards, rng, simulations):
...
def main():
    ...
    t_pipe = bench("pipeline", model, evaluator, boards, cboards, rng, SIMULATIONS)
    ...
    t_seq = bench("sequential", model, SyncEval(), boards, cboards, rng, SIMULATIONS)
