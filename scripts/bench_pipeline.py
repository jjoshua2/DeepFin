...
def bench(label: str, model, evaluator, boards, cboards, rng, simulations, pipeline: bool):  # pylint: disable=unused-argument  # skylos: ignore (pipeline kept for API parity with other benches)
