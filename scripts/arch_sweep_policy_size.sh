...
experiments=(
  "arch_11l_splitqkv_mlp_out_az4672_seed0|runs/offline_replay_epoch_arch_11l_splitqkv_mlp_out_az4672_seed0_${stamp}|--seed 0 --policy-encoding az_4672"
  "arch_11l_splitqkv_mlp_out_lc1858_seed4|runs/offline_replay_epoch_arch_11l_splitqkv_mlp_out_lc1858_seed4_${stamp}|--seed 4 --policy-encoding lc0_1858"
)
...
log "starting policy-size comparison queue: duration=${duration_s}s max_jobs=${max_jobs}"
start_s="$(date +%s)"
last_summary_s=0
