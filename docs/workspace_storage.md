...
See the [September 19 migration record](experiments/2026-09-19-workspace-storage.md)
for completed relocations, active-path constraints, qualifications and queued-job
adoption receipts.
