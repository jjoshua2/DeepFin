...
| Record | Scope |
| --- | --- |
| [Ceres100 policy endpoint preparation](2026-09-13-ceres100-policy-preparation.md) | Pure saved Ceres policy with SF values retained; seven-hour CPU preparation proposed, no training allocation |
...
| [Small G10 Ceres pilot](2026-09-11-g10-ceres-pilot.md) | 3,858,023 G10 Ceres rows / 472 shards qualified; complete run07 large launched for 2,008,952 more under unchanged 2h40 bound, not yet included; science remains first4 only |
...
| [Combined 35.3M value transfer](2026-09-13-combined35m-value-transfer.md) | Preregistered matched SF100 versus SF50/native-BT450 value comparison with common B100 policy; prospective admission and fresh 256-pair panel complete; explicit selected-subset preflight passed, no training launched |
| [All-move SF downside candidate](2026-09-12-sf-allmove-downside.md) | Completed 18.91M-row training at 2/2 workers; fixed 400-simulation comparison +17.66 Elo [−17.97, +53.66] versus B100, unresolved; no promotion or automatic extension |
