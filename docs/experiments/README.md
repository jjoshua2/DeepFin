...
| Record | Scope |
| --- | --- |
| [Faster recipe matches](2026-09-08-faster-recipe-matches.md) | Ordered-prefix SPRT preparation, two-budget allocation and banked occupancy; no measured rolling speedup |
