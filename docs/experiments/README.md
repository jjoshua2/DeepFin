...
| [Weighted Ceres bootstrap preparation](2026-09-11-ceres-weighted-bootstrap.md) | CeresB50 fixed-400: +12.22 Elo [-22.88, +47.57], 256 games; unresolved; immutable-bank readout recovered after command-capture finalizer failure; registered value training launched |
| [All-move SF downside candidate](2026-09-12-sf-allmove-downside.md) | One fixed >300 cp half-weight recipe; implementation and bounded prefix pilot prepared, no real rewrite or strength result |
