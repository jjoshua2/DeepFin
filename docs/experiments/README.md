...
| Record | Scope |
| --- | --- |
| [58M policy/value teacher factorial](2026-09-19-58m-policy-value-factorial.md) | Authorized four-arm comparison; exact-row Ceres coverage and immutable target-overlay preparation underway; no factorial training results |
