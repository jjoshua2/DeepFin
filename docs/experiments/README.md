...
| [Saved G10 value pilot and coverage](2026-09-11-g10-value-pilot-and-coverage.md) | 1,574,952 matched saved-SF rows; native BT4 WDL and metadata manifest admission complete for all 16,404,093 accepted common G10 positions; original B100 policy products now complete for all 20 (16,404,093 rows); fixed SF50/native BT4 WDL50 value products now also complete for all 20, including the four-root writer; [combined 35.3M SF100 completed; V50 host launched](2026-09-13-combined35m-value-transfer.md) |
...
| [Combined 35.3M value transfer](2026-09-13-combined35m-value-transfer.md) | SF100 matched epoch completed and verified; sequential V50 host launched with common seed 101 and 2/2 workers, fixed evaluation pending, no Elo result |
