...
| [Small G10 Ceres pilot](2026-09-11-g10-ceres-pilot.md) | 3,858,023 G10 Ceres rows / 472 shards qualified after run06 large completed in 6,106.741 driver seconds; no further collection launched; science remains first4 only |
...
| [All-move SF downside candidate](2026-09-12-sf-allmove-downside.md) | Fixed >300 cp half-weight recipe: full 18.91M-row rebuild, corpus qualification and prospective original schedule passed; three float16 move-entry support losses disclosed; 2/2-worker epoch launched September 13 UTC under 48/32 GiB memory guards; no completed model or playing result |
...
| [Bootstrap storage capacity](2026-09-08-bootstrap-storage-capacity.md) | Ongoing SSD-to-external transfer and verified reclamation for 100M; G20T1/G20T05/G50T05 reclamation complete; run04/run05 external copies verified and 870 closed shards reclaimed; metadata and unlisted tails retained; legacy E0 archive verified and 2,309 cold shard directories reclaimed; Tactical100 copy launched September 13 00:56 UTC, source retained and completion unread |
