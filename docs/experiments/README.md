...
| [Small G10 Ceres pilot](2026-09-11-g10-ceres-pilot.md) | 1,845,004 G10 Ceres rows qualified after both next96 cohorts; 2,013,019-row run06 large collection launched under 2h40 bound, not yet included; science remains first4 only |
...
| [Saved G10 value pilot and coverage](2026-09-11-g10-value-pilot-and-coverage.md) | 1,574,952 matched saved-SF rows; native BT4 WDL and metadata manifest admission complete for all 16,404,093 accepted common G10 positions; remaining 19 original B100 policy products launched sequentially; full-cohort value targets and training remain pending |
...
| [All-move SF downside candidate](2026-09-12-sf-allmove-downside.md) | One fixed >300 cp half-weight recipe; 8,192-row pilot passed; first full preparation interrupted by reboot; fresh unchanged-producer rebuild launched 18:37 UTC with lower memory bounds; no completion or strength result |
