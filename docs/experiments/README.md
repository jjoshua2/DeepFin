...
| Record | Scope |
| --- | --- |
| [Bend slider-index laws](2026-09-20-bend-slider-laws.md) | Updated checked U64 pin; inductive production-loop bridge and exhaustive canonical index/bounds certificate; native qualification remains separate |
