...
| Record | Scope |
| --- | --- |
| [SF tactical guidance for BT4 policy](2026-09-10-bt4-sf-tactical-training.md) | Matched18.91M epoch and realized schedule complete; CPU pair qualified, fixed400 match operator started; no playing result |
