...
| [Bootstrap storage capacity](2026-09-08-bootstrap-storage-capacity.md) | Ongoing SSD-to-external transfer and verified reclamation for 100M; G20T1/G20T05/G50T05 reclamation complete; run04/run05 external copies verified and 870 closed shards reclaimed; metadata and unlisted tails retained; legacy E0 archive verified and 2,309 cold shard directories reclaimed; Tactical100 archive verified and exact 2,309 shards reclaimed, both summaries and all experiment artifacts retained; Downside300 archive verified and exact 2,309 shards reclaimed, both summaries and all checkpoints retained; Ceres100 external copy verified and 2309 exact shards reclaimed, both summaries and all checkpoints retained; SoftSF10 archive verified and exact 2,309 shards reclaimed with both summaries retained; H20T05 copy-only archive launched, source retained and verification pending |
