...
| [Conservative research recovery](2026-09-12-conservative-research-recovery.md) | Guarded SF generation resumed with 2/1 active workers; one 15-cohort, 11.07M-position native-WDL batch launched under a two-hour cap; completion pending |
...
| [Saved G10 value pilot and coverage](2026-09-11-g10-value-pilot-and-coverage.md) | 1,574,952 matched saved-SF rows; original run06/run07 large plus run06 next96 native BT4 WDL complete (5,338,629 direct G10 rows); consumer admission still pending; no training/strength result |
