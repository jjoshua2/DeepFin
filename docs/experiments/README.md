...
| Record | Scope |
| --- | --- |
| [SF tactical guidance for BT4 policy](2026-09-10-bt4-sf-tactical-training.md) | Full18.91M corpus qualified after admission recovery; matched one-epoch training started, no playing result |
