...
| Record | Scope |
| --- | --- |
| [Bounded raw scale labels](2026-09-13-bounded-raw-scale-labels.md) | Completed 184 raw shards / 1,527,153 rows in 2638.682s; 12-group limit exhausted; baseline audit complete: 1,517,925 eligible rows, 30 phase-zero support failures and 9,198 no-result drops; exact filtered derivation complete: 1,517,925 rows / 186 derived shards; BT4 adapter and training admission pending |
