...
| Record | Scope |
| --- | --- |
| [Bounded raw scale labels](2026-09-13-bounded-raw-scale-labels.md) | Completed 184 raw shards / 1,527,153 rows in 2638.682s; 12-group limit exhausted; bounded baseline-eligibility CPU audit launched, no backfill or training admission |
...
| [Small G10 Ceres pilot](2026-09-11-g10-ceres-pilot.md) | 5,866,975 G10 Ceres rows / 718 shards qualified after run07 large completion; additional 131,072-row batch-v3 prefix collection launched with a one-hour limit; science remains first4 only |
