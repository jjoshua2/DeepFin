...
| Record | Scope |
| --- | --- |
| [Exact U32 slider-index correspondence](2026-09-21-bend-exact-slider-index.md) | Actual lookup/full-PEXT identity, ordinal, masked occupancy recovery and collision equivalence; prefix/affine storage remains separate |
