...
| [All-move SF downside candidate](2026-09-12-sf-allmove-downside.md) | Fixed >300 cp half-weight recipe: full 18.91M-row rebuild, corpus qualification and prospective original schedule passed; three float16 move-entry support losses disclosed; 2/2-worker training preparation pending, no playing result |
