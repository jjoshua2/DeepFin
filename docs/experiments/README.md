...
| Record | Scope |
| --- | --- |
| [Saved SF negative constraints](2026-09-11-sf-negative-constraints-screen.md) | Corrected 8,192-row audit qualified in 47 seconds; remaining 253,887-row CPU pass launched, no full-cohort or strength result |
