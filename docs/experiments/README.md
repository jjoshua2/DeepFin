...
| [Saved G10 value pilot and coverage](2026-09-11-g10-value-pilot-and-coverage.md) | 1,574,952 matched saved-SF rows; original run06 large native BT4 WDL complete at 2,013,019 rows (2,539,395 with increments); distinct output namespaces still need consumer admission; no training/strength result |
| [Weighted Ceres bootstrap preparation](2026-09-11-ceres-weighted-bootstrap.md) | Full 18,910,484-row Ceres bank qualified at September 12 01:41 UTC; collection complete, policy/value materialization concurrent with first contention check passed; another 524,288 native BT4 WDL rows completed, training pending, no playing result |
