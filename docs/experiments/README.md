...
| Record | Scope |
| --- | --- |
| [Ceres100 policy endpoint preparation](2026-09-13-ceres100-policy-preparation.md) | Pure-Ceres corpus and prospective epoch qualified; seed-0 2/2-worker training host launched, deciding B100 comparison pending |
