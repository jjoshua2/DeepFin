...
| Record | Scope |
| --- | --- |
| [Bend native leaf evaluation](2026-09-21-bend-native-leaf-evaluation.md) | Actual selected-leaf inputs, native CPU model and Bend probability conversion; opt-in and no runtime Python |
