...
| Record | Scope |
| --- | --- |
| [Ceres CPU semantics oracle](2026-09-13-ceres-cpu-semantics.md) | One-hour upstream CPU encoder/getter check launched on CPU 10,11; 16 explicit histories plus 128 saved rows, no result or neural parity claim |
| [Saved joint raw-label eligibility](2026-09-13-saved-joint-raw-eligibility.md) | 21.40M saved joint-label raw candidates outside covered rosters; 512-shard audit complete: 4,219,426 eligible / 4,249,935 raw rows; 88 required exclusions, loader extension and derivation pending; no training admission |
...
| [Native BT4 value endpoint](2026-09-13-native-bt4-value-endpoint.md) | Matched 35M V100-versus-V50 contrast; 35,314,577-row rewrite, prospective schedule and compatibility complete; V100 seed-101 training launched at 2/2 workers, arena pending |
