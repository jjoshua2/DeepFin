...
| [Saved G10 value pilot and coverage](2026-09-11-g10-value-pilot-and-coverage.md) | 1,574,952 matched saved-SF rows; native BT4 WDL and metadata manifest admission complete for all 16,404,093 accepted common G10 positions; original B100 policy products now complete for all 20 (16,404,093 rows); fixed SF50/native BT4 WDL50 value products now also complete for all 20, including the four-root writer; [combined 35.3M admission passed and SF100 trainer launched](2026-09-13-combined35m-value-transfer.md) |
...
| [Combined 35.3M value transfer](2026-09-13-combined35m-value-transfer.md) | Preregistered matched SF100 versus SF50/native-BT450 value comparison with common B100 policy; prospective admission and fresh 256-pair panel complete; explicit selected-subset preflight passed; SF100 trainer launched, V50/evaluation pending |
