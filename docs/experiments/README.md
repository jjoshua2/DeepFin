...
| Record | Scope |
| --- | --- |
| [Audited50M bootstrap expansion](2026-09-17-audited-scale-bootstrap.md) | Exact41,051,928 baseline-eligible rows;9,556,704 additional raw rows selected, eligibility unknown; saved-audit V50 admission and explicit50–60M profile prepared, no new train |
