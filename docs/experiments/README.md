...
| Record | Scope |
| --- | --- |
| [Actual fill interval frames](2026-09-23-bend-fill-interval-frames.md) | Six source laws derive full-count fill-clear certificates and actual outside/later/reserved-query preservation from bounded numeric intervals; metadata and final contents remain open |
