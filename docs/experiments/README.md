...
| Record | Scope |
| --- | --- |
| [SF-anchored value bootstrap](2026-09-08-sf-anchored-value-bootstrap.md) | Conditional modest neural WDL contribution with policy supervision fixed; historical Z limits and missing teacher-value bank made explicit |
...
| [G50 versus B100 policy dose](2026-09-08-bt4-g50-b100-dose-comparison.md) | Training complete and registered low/deep arenas launched; 50% versus 100% global BT4, no match result |
