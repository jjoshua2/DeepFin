...
| Record | Scope |
| --- | --- |
| [Explicit retained-Syzygy corpus option](2026-09-22-retained-syzygy-option.md) | Default-off worker/respawn forwarding, advertised support refusal and resume identity |
