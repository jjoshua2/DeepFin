...
| Record | Scope |
| --- | --- |
| [GPU watchdog incident and recovery hold](2026-09-23-gpu-watchdog-recovery.md) | Two user-reported watchdog bluescreens, incomplete loader ABBA, one-GPU-job rule, and staged recovery proposal; cause unestablished |
