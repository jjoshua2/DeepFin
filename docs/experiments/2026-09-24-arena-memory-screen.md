...
The completed equal-work panel is recorded below; successful measurement is not a performance or live-adoption verdict.


### Completed hosted screen

Run https://github.com/jjoshua2/DeepFin/actions/runs/36003863999 completed all preceding stages. All 133 focused Python tests passed without skips (42 new), explicit static checks and whole-repository Ruff/Basedpyright/Vulture passed. The exact qualified C was rebuilt with Clang 18 and unchanged callback/worker. No new Bend generation or runtime change is claimed.

All 100 measured child runs completed equal requested work, with 20 separately excluded warmups. Four baseline diagnostics passed the independent CBoard/Python-chess input/tree/accounting oracle; all 20 diagnostic runs matched across capacities within each workload. Each measured RSS record and stdout hash was reconciled to raw files. Five observations per cell, rotating capacity order.

| Roots | Simulations/root | Logical capacity | Physical slots/root | Peak RSS median MiB | Peak RSS range MiB | Whole-process median ms |
|---:|---:|---:|---:|---:|---|---:|
| 1 | 1 | 4096 | 4096 | 11.67 | 11.06..11.85 | 18.03 |
| 1 | 1 | 4097 | 8192 | 13.63 | 13.24..13.77 | 18.17 |
| 1 | 1 | 8192 | 8192 | 13.77 | 13.12..13.80 | 18.00 |
| 1 | 1 | 16384 | 16384 | 11.70 | 11.69..11.82 | 18.09 |
| 1 | 1 | 65536 | 65536 | 17.98 | 17.11..18.14 | 19.90 |
| 1 | 64 | 4096 | 4096 | 12.31 | 11.73..12.37 | 35.93 |
| 1 | 64 | 4097 | 8192 | 14.34 | 14.32..14.38 | 36.61 |
| 1 | 64 | 8192 | 8192 | 14.31 | 14.27..14.39 | 35.49 |
| 1 | 64 | 16384 | 16384 | 12.29 | 12.15..12.42 | 35.86 |
| 1 | 64 | 65536 | 65536 | 18.27 | 18.23..18.37 | 36.66 |
| 16 | 1 | 4096 | 4096 | 19.77 | 19.75..20.38 | 24.84 |
| 16 | 1 | 4097 | 8192 | 28.33 | 28.28..28.43 | 26.73 |
| 16 | 1 | 8192 | 8192 | 28.34 | 28.23..28.38 | 32.42 |
| 16 | 1 | 16384 | 16384 | 44.34 | 44.31..44.39 | 35.98 |
| 16 | 1 | 65536 | 65536 | 140.34 | 140.27..140.41 | 51.48 |
| 16 | 64 | 4096 | 4096 | 20.37 | 20.22..20.39 | 329.56 |
| 16 | 64 | 4097 | 8192 | 28.34 | 28.31..28.41 | 330.03 |
| 16 | 64 | 8192 | 8192 | 28.34 | 28.29..28.42 | 329.28 |
| 16 | 64 | 16384 | 16384 | 44.33 | 44.29..44.46 | 333.07 |
| 16 | 64 | 65536 | 65536 | 140.29 | 140.15..140.36 | 356.01 |
