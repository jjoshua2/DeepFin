...
def initial(path):
 value=read(path);require(value['seed']==122,'initial seed differs')
...
def main():
 ...
 require(p['arm'] in ['D122','E122'],'second-seed replica runner')
 ...
 try:
  ...
  dump(HERE/'actual_command.json',{'command':command,'bound_inputs':pins,'fresh_seed':122})
  ...
  require(summary['seed']==122 and summary['batch_size']==512 and summary['steps_realized']==113459,'realized training settings differ')
