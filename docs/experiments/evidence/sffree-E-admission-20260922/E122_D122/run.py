...
def bind_one(donor):
 ...
 require(facts['seed']==122 and facts['batch_size']==512 and facts['steps_realized']==113459 and facts.get('continuation') is None,'requires fresh matched training')
 ...
 initial_facts=op.load(Path(initial['path']));require(initial_facts['seed']==122 and initial_facts['tensor_sha256']==receipt['tensor_sha256'],'initial tensor identity differs')
