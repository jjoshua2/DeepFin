...
External output: /home/<user>/chess-artifacts/runs/expanded58m_vs50m_20260920. Controls, model/summary/terminal pins and queue proposal are alongside this document. Proposed position: after the reviewed BT4 batch benchmark and before final factorial preparation, only while preparation remains queued. CPU preparation sidecar can continue during the arena; GPU ownership remains serialized by the existing lease.
