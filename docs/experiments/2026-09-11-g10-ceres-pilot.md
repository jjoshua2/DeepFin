...
Fresh output: `~/projects/chess/data/lc0/ceres_compact_sidecars/g10_run06_first4_v1`. The collector generates a fresh timestamped invocation directory under this output; freshness is enforced before execution. No existing output is relabeled or modified.
