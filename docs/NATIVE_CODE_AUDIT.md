...
surface is 9,331 lines:

| Review unit | Files | Lines | Status |
|---|---|---:|---|
| Board core and binding | `encoding/_cboard_impl.h`, `encoding/_lc0_ext.c` | 2,519 | finding |
| Feature/relation core and binding | `encoding/_features_impl.h`, `encoding/_features_ext.c` | 1,509 | finding |
| MCTS extension | `mcts/_mcts_tree.c` | 5,171 | finding |
...
| N001–N008 (remaining + N002 reads) | this PR (`fix/native-code-audit`) | native validation suite + castling parity + thread-safety | open |
