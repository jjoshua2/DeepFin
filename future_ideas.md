...
- Remaining from the original sketch: switch the soft-CE loss to sparse CE over gathered log-probs with analytic smoothing, then stop writing the dense `sf_policy_target` once a full replay window carries sparse labels.
