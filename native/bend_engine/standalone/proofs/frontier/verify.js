...
const parent=run('../parser/verify.js',10800000);
assert.equal(parent.proof_gate,'PASS');assert.equal(parent.aggregate_law_count,137);
assert.equal(parent.inherited_negative_controls,367);assert.equal(parent.negative_controls.length,17);
...
const result={proof_gate:'PASS',aggregate_law_count:141,new_law_count:4,inherited_law_count:137,
 inherited_negative_controls:384,negative_controls:focused.negative_controls,
