...
const parent=run('../abstraction/verify.js',10800000);
assert.equal(parent.proof_gate,'PASS');assert.equal(parent.aggregate_law_count,132);
assert.equal(parent.inherited_negative_controls,350);assert.equal(parent.negative_controls.length,17);
...
const result={proof_gate:'PASS',aggregate_law_count:137,new_law_count:5,inherited_law_count:132,
 inherited_negative_controls:367,negative_controls:focused.negative_controls,
