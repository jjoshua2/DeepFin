// Opt-in complete aggregate, including all inherited gates. Modular evidence is reported separately.
...
const parent=check('../data/verify.js',10800000);
...
console.error('PASS: unchanged 106-law parent and all 260 inherited rejection controls');
...
const report={proof_gate:'PASS',compiler_revision:p.compiler_revision,...identity,aggregate_law_count:109,new_law_count:3,inherited_law_count:106,
 inherited_negative_controls:260,new_laws:p.new_laws,negative_controls:p.negative_controls,
