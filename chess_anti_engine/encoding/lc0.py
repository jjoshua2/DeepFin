...
def normalize_lc0_history_encoding(input_history_encoding: str | None) -> str:
    ...
    try:
        ...
        raise ValueError(
            ...
            f"expected '{LC0_HISTORY_LEGACY}' or '{LC0_HISTORY_ROOT}'"
        ) from exc
...
def encode_lc0_full(
    ...
    *,
    ...
    """
    if normalize_lc0_history_encoding(input_history_encoding) == LC0_HISTORY_ROOT:
        return encode_lc0_full_root(board, history_len=history_len)
...
def encode_lc0_full_c(
    ...
    *,
    ...
    """
    if normalize_lc0_history_encoding(input_history_encoding) == LC0_HISTORY_ROOT:
        return _encode_lc0_full_root_c(board, history_len=history_len)
