...
static PyObject* PyCBoard_encode_146_lc0_root_legacy_meta(PyCBoard *self, PyObject *Py_UNUSED(args)) {
...
static PyMethodDef PyCBoard_methods[] = {
    ...
    {"encode_146_lc0_root_legacy_meta", (PyCFunction)PyCBoard_encode_146_lc0_root_legacy_meta, METH_NOARGS,
