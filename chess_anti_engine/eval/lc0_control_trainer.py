...
LIVE_TRAINER_PIN: dict[str, Any] = {
    ...
    "live_commit": "e94862771",
    "provenance": (
        "bt4heads bundle promoted 2026-08-15 (w_categorical 0.0 -> 1.0, rebuild_categorical_target on, categorical blend 0.69/0.31); the SF-teacher heads zeroed; warmup 1000; sf_policy_score_mode cp; arm F (w_sf_policy_floor 0.8 + collar) live since 2026-08-17 via PR #448"
    ),
    "kwargs": {
            "accum_steps": 1,
            ...
            "sf_policy_floor_delta_cp": 20.0,
            "sf_policy_floor_gumbel_topk": 16,
            "sf_policy_floor_tau": 0.15,
