...
def main() -> None:
  ...
  # Bootstrap and gating
    ...
    ap.add_argument("--sf-nice", type=int, default=0, help="Absolute POSIX nice target for Stockfish subprocesses, clamped to 0..19; never raises priority above the parent.")
