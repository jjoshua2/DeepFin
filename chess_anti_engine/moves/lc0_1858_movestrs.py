"""Canonical LC0/Leela 1858 policy index -> UCI move string table.

Extracted verbatim from lc0 src/neural/encoder.cc `kMoveStrs[]` (the
array `MoveFromNNIndex` indexes). Index i is the i-th slot of a Leela
network policy output. All entries are White-POV moves; for a black-to-
move position the board must be vertically mirrored first (lc0 does this
via its input transform). Source of truth for decoding real Leela/Ceres
ONNX policy heads (e.g. BT4).
"""
from __future__ import annotations

LC0_1858_MOVE_STRS: tuple[str, ...] = (
