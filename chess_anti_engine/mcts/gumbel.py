...
def run_gumbel_root_many(
    ...
    *,
    ...
    per_game_simulations: list[int] | None = None,  # skylos: ignore (API parity with run_gumbel_root_many_async)
    per_game_add_noise: list[bool] | None = None,  # skylos: ignore (API parity with run_gumbel_root_many_async)
