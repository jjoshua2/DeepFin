...
static PyObject *py_batch_process_ply(PyObject *self, PyObject *args) {
    ...
    PyArrayObject *out_priority_policy_kl = (PyArrayObject *)PyArray_SimpleNew(1, dims_n, NPY_FLOAT32);
    PyArrayObject *out_priority_q_delta = (PyArrayObject *)PyArray_SimpleNew(1, dims_n, NPY_FLOAT32);
    ...
    float *priority_policy_kl_out = (float *)PyArray_DATA(out_priority_policy_kl);
    float *priority_q_delta_out = (float *)PyArray_DATA(out_priority_q_delta);
...
static PyObject *py_batch_encode_146_lc0_root_legacy_meta(PyObject *self, PyObject *args) {
    PyObject *cboards_list;
    PyObject *out_obj;
...
static PyObject *py_batch_encode_146_lc0_root_legacy_meta_bf16(PyObject *self, PyObject *args) {
    PyObject *cboards_list;
    PyObject *out_obj;
...
static PyMethodDef module_methods[] = {
    ...
    {"batch_encode_146_lc0_root_legacy_meta", py_batch_encode_146_lc0_root_legacy_meta, METH_VARARGS,
     "batch_encode_146_lc0_root_legacy_meta(cboards_list, out_array) -> None. "
    ...
    {"batch_encode_146_lc0_root_legacy_meta_bf16", py_batch_encode_146_lc0_root_legacy_meta_bf16, METH_VARARGS,
